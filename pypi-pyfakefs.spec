...
Version  : 4.6.0
Release  : 9
URL      : https://files.pythonhosted.org/packages/b3/26/17b3d0f6b0c342c69a069b70e0d2491671f53ba2db53b54db4db3bf2f4bf/pyfakefs-4.6.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/b3/26/17b3d0f6b0c342c69a069b70e0d2491671f53ba2db53b54db4db3bf2f4bf/pyfakefs-4.6.0.tar.gz
...
%prep
%setup -q -n pyfakefs-4.6.0
cd %{_builddir}/pyfakefs-4.6.0
pushd ..
cp -a pyfakefs-4.6.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657659913
...
cp %{_builddir}/pyfakefs-4.6.0/COPYING %{buildroot}/usr/share/package-licenses/pypi-pyfakefs/89608a8f5632e1430c94fc5725a8aaea1a106ba6
