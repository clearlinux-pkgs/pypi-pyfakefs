...
Source0  : https://files.pythonhosted.org/packages/07/bd/f90ac3d871b2b7f6799d8b768c768526e509e15b50821fe21943a250d417/pyfakefs-5.4.0.tar.gz
...
%prep
%setup -q -n pyfakefs-5.4.0
cd %{_builddir}/pyfakefs-5.4.0
pushd ..
cp -a pyfakefs-5.4.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712500613
