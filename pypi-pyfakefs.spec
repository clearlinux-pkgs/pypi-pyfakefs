...
Source0  : https://files.pythonhosted.org/packages/9b/4a/7e64b11813deb0aa8f77ef71dcaf2388c31cc992f9fba8f222d539f160d0/pyfakefs-5.3.1.tar.gz
...
%prep
%setup -q -n pyfakefs-5.3.1
cd %{_builddir}/pyfakefs-5.3.1
pushd ..
cp -a pyfakefs-5.3.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1700150816
