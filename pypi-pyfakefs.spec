...
Version  : 5.4.1
Release  : 36
URL      : https://files.pythonhosted.org/packages/74/8c/5a8d25e21d6b42ea6c454e24d88802d25059c7460f45663ff43215ceea65/pyfakefs-5.4.1.tar.gz
...
%prep
%setup -q -n pyfakefs-5.4.1
cd %{_builddir}/pyfakefs-5.4.1
pushd ..
cp -a pyfakefs-5.4.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712937840
