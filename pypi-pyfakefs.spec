...
Version  : 4.6.3
Release  : 14
URL      : https://files.pythonhosted.org/packages/2e/a1/1592dc4297583de8e4a11ec473c71e3d77295aa619384e728e86315ff869/pyfakefs-4.6.3.tar.gz
Source0  : https://files.pythonhosted.org/packages/2e/a1/1592dc4297583de8e4a11ec473c71e3d77295aa619384e728e86315ff869/pyfakefs-4.6.3.tar.gz
...
%prep
%setup -q -n pyfakefs-4.6.3
cd %{_builddir}/pyfakefs-4.6.3
pushd ..
cp -a pyfakefs-4.6.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1658415344
...
cp %{_builddir}/pyfakefs-4.6.3/COPYING %{buildroot}/usr/share/package-licenses/pypi-pyfakefs/89608a8f5632e1430c94fc5725a8aaea1a106ba6
