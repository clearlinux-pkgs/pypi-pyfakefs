...
Version  : 5.1.0
Release  : 21
URL      : https://files.pythonhosted.org/packages/38/4b/0e12c26797eeb1ea4574f3b94937817ee781a13d3fb800c2dc4c115a56f3/pyfakefs-5.1.0.tar.gz
...
%prep
%setup -q -n pyfakefs-5.1.0
cd %{_builddir}/pyfakefs-5.1.0
pushd ..
cp -a pyfakefs-5.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673626322
