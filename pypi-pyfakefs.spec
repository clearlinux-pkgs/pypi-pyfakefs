...
Version  : 5.3.5
Release  : 34
URL      : https://files.pythonhosted.org/packages/00/2f/0fb6e7c3119fd9935cc1608a3b79de70bad8c2b400654b7e38e35120ff91/pyfakefs-5.3.5.tar.gz
...
%prep
%setup -q -n pyfakefs-5.3.5
cd %{_builddir}/pyfakefs-5.3.5
pushd ..
cp -a pyfakefs-5.3.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1706719699
