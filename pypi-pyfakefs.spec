...
Version  : 4.6.1
Release  : 10
URL      : https://files.pythonhosted.org/packages/85/62/31c5dd294f2fefe763065b7204096da6274177c650e2a89f171c1ff87c96/pyfakefs-4.6.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/85/62/31c5dd294f2fefe763065b7204096da6274177c650e2a89f171c1ff87c96/pyfakefs-4.6.1.tar.gz
...
%prep
%setup -q -n pyfakefs-4.6.1
cd %{_builddir}/pyfakefs-4.6.1
pushd ..
cp -a pyfakefs-4.6.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657755410
...
cp %{_builddir}/pyfakefs-4.6.1/COPYING %{buildroot}/usr/share/package-licenses/pypi-pyfakefs/89608a8f5632e1430c94fc5725a8aaea1a106ba6
