...
Source0  : https://files.pythonhosted.org/packages/1a/8e/c8bbcc7610781dbd513faafff10bb71ed3f64de4524f8558cd855c86c444/pyfakefs-5.3.0.tar.gz
...
%prep
%setup -q -n pyfakefs-5.3.0
cd %{_builddir}/pyfakefs-5.3.0
pushd ..
cp -a pyfakefs-5.3.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697054748
