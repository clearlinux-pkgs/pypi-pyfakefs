...
Version  : 5.6.0
Release  : 38
URL      : https://files.pythonhosted.org/packages/11/28/661bbbd3479b80b1185e4dfb8373fdf9191dedb9725765bcbf412ceaeb6c/pyfakefs-5.6.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/11/28/661bbbd3479b80b1185e4dfb8373fdf9191dedb9725765bcbf412ceaeb6c/pyfakefs-5.6.0.tar.gz
...
%prep
%setup -q -n pyfakefs-5.6.0
cd %{_builddir}/pyfakefs-5.6.0
pushd ..
cp -a pyfakefs-5.6.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721062393
