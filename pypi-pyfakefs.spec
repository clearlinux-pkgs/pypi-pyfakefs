...
Version  : 4.6.2
Release  : 11
URL      : https://files.pythonhosted.org/packages/74/19/edc80e1f3f886314954bec748c5a326e3e94ba2857223c63778ad6333230/pyfakefs-4.6.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/74/19/edc80e1f3f886314954bec748c5a326e3e94ba2857223c63778ad6333230/pyfakefs-4.6.2.tar.gz
...
%prep
%setup -q -n pyfakefs-4.6.2
cd %{_builddir}/pyfakefs-4.6.2
pushd ..
cp -a pyfakefs-4.6.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657894859
...
cp %{_builddir}/pyfakefs-4.6.2/COPYING %{buildroot}/usr/share/package-licenses/pypi-pyfakefs/89608a8f5632e1430c94fc5725a8aaea1a106ba6
