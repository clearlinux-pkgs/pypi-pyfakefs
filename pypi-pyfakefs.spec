...
Version  : 5.3.4
Release  : 33
URL      : https://files.pythonhosted.org/packages/fe/a7/834b92ad745323c592ce7d187f9f2248797675ce9a91922d849d671969a4/pyfakefs-5.3.4.tar.gz
Source0  : https://files.pythonhosted.org/packages/fe/a7/834b92ad745323c592ce7d187f9f2248797675ce9a91922d849d671969a4/pyfakefs-5.3.4.tar.gz
...
%prep
%setup -q -n pyfakefs-5.3.4
cd %{_builddir}/pyfakefs-5.3.4
pushd ..
cp -a pyfakefs-5.3.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1705702800
