...
Version  : 5.8.0
Release  : 46
URL      : https://files.pythonhosted.org/packages/a8/50/a839c8812899e8955223d95b27767480856f9723b3230ddee0472cf1dbe2/pyfakefs-5.8.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/a8/50/a839c8812899e8955223d95b27767480856f9723b3230ddee0472cf1dbe2/pyfakefs-5.8.0.tar.gz
...
%prep
%setup -q -n pyfakefs-5.8.0
cd %{_builddir}/pyfakefs-5.8.0
pushd ..
cp -a pyfakefs-5.8.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1741725604
