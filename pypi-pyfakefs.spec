...
Version  : 4.5.4
Release  : 4
URL      : https://files.pythonhosted.org/packages/42/00/f673ec8240ed5fee19f71b08ac735fb6daaefb5c15e1eb8fdd02bdcdbd72/pyfakefs-4.5.4.tar.gz
Source0  : https://files.pythonhosted.org/packages/42/00/f673ec8240ed5fee19f71b08ac735fb6daaefb5c15e1eb8fdd02bdcdbd72/pyfakefs-4.5.4.tar.gz
...
%prep
%setup -q -n pyfakefs-4.5.4
cd %{_builddir}/pyfakefs-4.5.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1642031260
...
cp %{_builddir}/pyfakefs-4.5.4/COPYING %{buildroot}/usr/share/package-licenses/pypi-pyfakefs/89608a8f5632e1430c94fc5725a8aaea1a106ba6
